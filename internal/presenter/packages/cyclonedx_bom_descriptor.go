...
// NewCyclconeDxBomDescriptor returns a new CycloneDxBomDescriptor tailored for the current time and "syft" tool details.
func NewCyclconeDxBomDescriptor(name, version string, srcMetadata source.Metadata) *CycloneDxBomDescriptor {
